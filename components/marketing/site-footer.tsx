...
const footerLinks = {
    ...
    resources: [
        ...
        {
            href: '/resources/soc2-audit-trail-checklist',
            label: 'SOC 2 Checklist'
        },
                ...
                <div className="grid gap-8 md:grid-cols-4">
                    <div className="md:col-span-2">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground max-w-sm">
                            Compliance-grade audit logging. Immutable trails,
                            multi-region residency, auditor-ready exports.
                        </p>
                        <div className="mt-6">
                    ...
                    <div>
                        ...
                        <ul
                            aria-label="Footer resources and legal links"
                            className="mt-3 space-y-2"
                        >
