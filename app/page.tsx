...
const features = [
    {
        ...
        desc: 'Hash-chain immutability',
        icon: Lock
    },
    {
        title: 'Multi-region residency',
        desc: 'Data stays where you need it',
        icon: Globe
    },
    {
        title: 'Retention & archive',
        desc: 'Hot storage and long-term archive',
        icon: FileCheck
    },
    {
        title: 'Auditor-ready exports',
        desc: 'CSV, JSON, and evidence packages',
        icon: FileCheck
    },
...
export default function HomePage() {
    ...
    return (
        <div>
            ...
            <section
                className={`${sectionClass} border-b bg-premium bg-grid bg-noise`}
            >
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <h2 className="mx-auto mt-3 max-w-2xl text-center text-2xl font-semibold md:text-3xl">
                        When auditors ask how you prove immutability, you need
                        answers — not spreadsheets
                    </h2>
                    <p className="mx-auto mt-4 max-w-xl text-center text-muted-foreground">
                        B2B SaaS going upmarket — fintech, health, HR, security,
                        GovTech — facing SOC 2, GDPR, and security review
                        pressure.
                    </p>
                </div>
            </section>
            ...
            <section className={`${sectionClass} border-b`}>
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-center text-muted-foreground">
                        Instrument once, store with integrity, export when
                        auditors ask.
                    </p>
            ...
            >
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-center text-muted-foreground">
                        Tamper-evident storage, region controls, and
                        auditor-ready exports in one platform.
                    </p>
            ...
            <section className={`${sectionClass} border-b`}>
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-center text-muted-foreground">
                        Designed for SOC 2, GDPR, and ISO-aligned environments.
                        We give you the controls and evidence structure auditors
                        expect — without the cost of building it yourself.
                    </p>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="mx-auto max-w-xl text-center">
                        ...
                        <p className="mt-2 text-muted-foreground">
                            Prepare for security reviews with our practical
                            checklist.
                        </p>
